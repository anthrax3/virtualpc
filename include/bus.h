...
struct bus_memory_mapping_s
{
	...
	void *user;
	enum bus_error(*read)(void *user, uintptr_t address, uintptr_t length, void *buffer);
	enum bus_error(*write)(void *user, uintptr_t address, uintptr_t length, void *buffer);
